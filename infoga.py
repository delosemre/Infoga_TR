...
class Infoga(object):
	...
	def Banner(self):
		...
		print self.c.red(1)+"     Edit - delosemre(S0lid Night)    "+self.c.end()
	...
	def Usage(self):
		...
		print "\t-t --target\tDomain Arama"
		print "\t-s --source\tVeri Kaynagi: [all,google,bing,yahoo,pgp]"
		print "\t-i --info\tGet e-posta bilgilerini al"
		print "\t--update\tAraci Guncelle"
		print "\t--version\tversiyon bilgileri"
		print "\t--help\t\tyardimi goster ve cık\n"
		print "Ornek:"
